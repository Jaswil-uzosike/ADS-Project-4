...
class Program
{
    static void Main(string[] args)
    {
        ...
        string datasetPath = "C:\\Users\\izunn\\OneDrive - Sheffield Hallam University\\BinPacking2\\BinPacking2\\ADSLab9\\weightDataset.csv";
        ...
        int iterations = 10000; // Set the number of iterations
